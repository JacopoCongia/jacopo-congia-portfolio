  ...
  return (
    <footer className="relative flex flex-col items-center bg-retro-brown py-[3em] text-center text-retro-cream">
      <div className="flex gap-[0.8em] text-[50px]">
        ...
        <a
          href="https://www.linkedin.com/in/jacopo-congia/"
          target="_blank"
          rel="noreferrer"
        >
          <svg
        ...
        <a
          href="https://www.instagram.com/tako__jako/"
          target="_blank"
          rel="noreferrer"
          className="text-retro-cream hover:text-retro-yellow"
        >
          <BsInstagram className="duration-[0.2s]" />
        </a>
      </div>
      <a
        href="#home"
