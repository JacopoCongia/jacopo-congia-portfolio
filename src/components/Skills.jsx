function Skills() {
  return (
    <div className="flex flex-wrap gap-[2em] px-[1.5em] items-center justify-center min-[1200px]:min-w-[50%] min-[1200px]:grid min-[1200px]:grid-cols-3 min-[1400px]:grid min-[1400px]:grid-cols-4">
